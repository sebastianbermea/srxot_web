...
const Qualities = () => {
    const quals = [
        ...
        { id: 2, img: qual2, title: "NO RASPA", text: "Se combinan los sabores naturales y el porcentaje de alcohol para hacer que esta botella no cale en la garganta y sea disfrutable para todos." },
    ...
    return (
        <div>
            ...
            <div className='qualities-wrapper'>
                {quals.map((qual) => (
                    <div className='qual-row' key={"qual-" + qual.index}>
